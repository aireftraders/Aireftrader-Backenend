...
const adminAuth = require('../middlewares/adminAuth'); // Your admin auth middleware

// Announcement management
router.post('/announcements', adminAuth, announcementController.createAnnouncement);
router.patch('/announcements/:id/toggle', adminAuth, announcementController.toggleAnnouncement);
